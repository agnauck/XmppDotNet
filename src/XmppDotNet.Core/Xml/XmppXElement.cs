...
namespace XmppDotNet.Xml
{
    ...
    public class XmppXElement : XElement
    {
        ...
        /// <summary>
        /// Does the element represent a StartTag only?
        /// </summary>
        ...
        /// <summary>
        /// Does the element represent an EndTag only?
        /// </summary>
        ...
        public virtual string ToString(bool indented)
        {
            ...
            return base.ToString(indented ? SaveOptions.None : SaveOptions.DisableFormatting);
