namespace XmppDotNet.Xml.Parser
{
    ...
    /// <summary>
    /// Stream Parser is a lightweight streaming Xml parser designed for XMPP Xml streams.
    ...
    public class StreamParser
    {
        ...
        public void Write(byte[] buf, int offset, int length)
        {
            ...
            byteBuffer.Write(copy);

            byte[] b = byteBuffer.GetBuffer();
            int off = 0;
