namespace XmppDotNet.Xmpp
{
    ...
    public class Namespaces
    {
        ...
        /// <summary>
        /// urn:xmpp:alt-connections:websocket ( XEP-0156: Discovering Alternative XMPP Connection Methods)
        /// </summary>
        public const string AlternativeConnectionsWebSocket = "urn:xmpp:alt-connections:websocket";
