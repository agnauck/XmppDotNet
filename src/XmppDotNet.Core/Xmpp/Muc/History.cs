...
namespace XmppDotNet.Xmpp.Muc
{
    ...
    */
    ...
    public class History : XmppXElement
    {
        ...
        {
            get { return XmppDotNet.Time.Iso8601Date(GetAttribute("since")); }
            set { SetAttribute("since", XmppDotNet.Time.Iso8601Date(value)); }
        }
        ...
        #region << Operators >>
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Int32"/> to <see cref="XmppDotNet.Xmpp.Muc.History"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.DateTime"/> to <see cref="XmppDotNet.Xmpp.Muc.History"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="XmppDotNet.Xmpp.Muc.History"/> to <see cref="System.Int32"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="XmppDotNet.Xmpp.Muc.History"/> to <see cref="System.DateTime"/>.
        /// </summary>
        /// <param name="history">The history.</param>
        /// <returns>The result of the conversion.</returns>
