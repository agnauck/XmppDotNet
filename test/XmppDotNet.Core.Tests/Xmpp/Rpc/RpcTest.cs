...
using XmppDotNet.Xmpp.Rpc;
using Shouldly;
using Xunit;

namespace XmppDotNet.Tests.Xmpp.Rpc
{
    public class RpcTest
    {
        ...
        {
            XmppXElement.LoadXml(Resource.Get("Xmpp.Rpc.rpc_query1.xml")).ShouldBeOfType<XmppDotNet.Xmpp.Rpc.Rpc>();
        }

        [Fact]
        public void TestRpcQuery()
        {
            var rpc = XmppXElement.LoadXml(Resource.Get("Xmpp.Rpc.rpc_query1.xml")).Cast<XmppDotNet.Xmpp.Rpc.Rpc>();
        ...
        {
            var rpc = new XmppDotNet.Xmpp.Rpc.Rpc();
        ...
        {
            var rpc = XmppXElement.LoadXml(Resource.Get("Xmpp.Rpc.rpc_query_response1.xml")).Cast<XmppDotNet.Xmpp.Rpc.Rpc>();
