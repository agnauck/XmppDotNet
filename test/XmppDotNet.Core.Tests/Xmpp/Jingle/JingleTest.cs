...
namespace XmppDotNet.Tests.Xmpp.Jingle
{
    public class JingleTest
    {
        ...
        public void TestCreateJingleIq()
        {
            var iq = new JingleIq
                {
                    ...
                    Jingle =
                        {
                            Action = XmppDotNet.Xmpp.Jingle.Action.SessionInitiate,
            ...
            // Transport
            var transport = new XmppDotNet.Xmpp.Jingle.Transports.TransportRawUdp();
        ...
        {
            XmppXElement.LoadXml(Resource.Get("Xmpp.Jingle.jingle1.xml")).ShouldBeOfType<XmppDotNet.Xmpp.Jingle.Jingle>();
        }

        [Fact]
        public void TestJingleProperties()
        {
            var jingle = XmppXElement.LoadXml(Resource.Get("Xmpp.Jingle.jingle1.xml")).Cast<XmppDotNet.Xmpp.Jingle.Jingle>();
