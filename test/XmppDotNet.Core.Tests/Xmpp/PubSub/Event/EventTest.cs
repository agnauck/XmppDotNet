...
namespace XmppDotNet.Tests.Xmpp.PubSub.Event
{
    public class EventTest
    {
        ...
        {
            XmppXElement.LoadXml(Resource.Get("Xmpp.PubSub.Event.event1.xml")).ShouldBeOfType<XmppDotNet.Xmpp.PubSub.Event.Event>();
        }

        [Fact]
        public void TestEvent()
        {
            var ev = XmppXElement.LoadXml(Resource.Get("Xmpp.PubSub.Event.event1.xml")).Cast<XmppDotNet.Xmpp.PubSub.Event.Event>();
            ...
            ev = XmppXElement.LoadXml(Resource.Get("Xmpp.PubSub.Event.event2.xml")).Cast<XmppDotNet.Xmpp.PubSub.Event.Event>();
            ...
            ev = XmppXElement.LoadXml(Resource.Get("Xmpp.PubSub.Event.event3.xml")).Cast<XmppDotNet.Xmpp.PubSub.Event.Event>();
            Assert.Equal(PubSubEventType.Configuration, ev.Type);
            Assert.NotEqual(PubSubEventType.Delete, ev.Type);


            ev = XmppXElement.LoadXml(Resource.Get("Xmpp.PubSub.Event.event4.xml")).Cast<XmppDotNet.Xmpp.PubSub.Event.Event>();
            ...
            ev = XmppXElement.LoadXml(Resource.Get("Xmpp.PubSub.Event.event5.xml")).Cast<XmppDotNet.Xmpp.PubSub.Event.Event>();
            Assert.NotEqual(PubSubEventType.Items, ev.Type);
        ...
        {
            var ev2 = new XmppDotNet.Xmpp.PubSub.Event.Event
            {
            ...
            ev2 = new XmppDotNet.Xmpp.PubSub.Event.Event { Type = PubSubEventType.Delete };
            ...
            var ev3 = new XmppDotNet.Xmpp.PubSub.Event.Event
            {
        ...
        public void Test3()
        {
            var ev2 = new XmppDotNet.Xmpp.PubSub.Event.Event
                          {
                              Configuration = new XmppDotNet.Xmpp.PubSub.Event.Configuration {Node = "princely_musings"}
                          };
        ...
        {
            var ev = XmppXElement.LoadXml(Resource.Get("Xmpp.PubSub.Event.event6.xml")).Cast<XmppDotNet.Xmpp.PubSub.Event.Event>();
            Assert.NotEqual(PubSubEventType.Items, ev.Type);
            ...
            Assert.Equal(XmppDotNet.Xmpp.PubSub.SubscriptionState.Subscribed, ev.Subscription.SubscriptionState);
        }
                ...
                Subscription =
                    {
                        ...
                        SubscriptionState = XmppDotNet.Xmpp.PubSub.SubscriptionState.Subscribed
                    }
            };
        ...
        {
            DateTime dt;
            XmppXElement xmpp1 = XmppXElement.LoadXml(Resource.Get("Xmpp.PubSub.Event.event7.xml")).Cast<XmppDotNet.Xmpp.PubSub.Event.Event>();
            
            var ev = xmpp1 as XmppDotNet.Xmpp.PubSub.Event.Event;
            Assert.NotEqual(PubSubEventType.Items, ev.Type);
            Assert.Equal(PubSubEventType.Subscription, ev.Type);
            ...
            ev2 = new XmppDotNet.Xmpp.PubSub.Event.Event
            {
                Type = PubSubEventType.Subscription,
                Subscription =
                                  {
