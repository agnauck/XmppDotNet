...
using XmppDotNet.Xmpp.AdvancedMessageProcessing;
using Shouldly;
using Xunit;

namespace XmppDotNet.Tests.Xmpp.AdvancedMessageProcessing
{
    public class RuleTest
    {
        ...
        public void TestAction()
        {
            XmppXElement.LoadXml(Resource.Get("Xmpp.AdvancedMessageProcessing.rule1.xml"))
                .Cast<Rule>()
                .Action.ShouldBe(XmppDotNet.Xmpp.AdvancedMessageProcessing.Action.Error);
        }
        ...
        public void TestExpireAt()
        {
            ...
            Assert.True(rule.ValueAsDateTime.ToUniversalTime().Equals(new DateTime(2004, 1, 1, 0, 0, 0)));
        }
        ...
        public void BuildRule()
        {
            ...
            {
                Action =
                      XmppDotNet.Xmpp.AdvancedMessageProcessing.Action.Error,
        ...
        public void BuildRule2()
        {
            ...
            new Rule
            {
                Action = XmppDotNet.Xmpp.AdvancedMessageProcessing.Action.Error,
