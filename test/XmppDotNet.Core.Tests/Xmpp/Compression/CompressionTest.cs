...
namespace XmppDotNet.Tests.Xmpp.Compression
{
    public class CompressionTest
    {
        ...
        {
            var feats = XmppXElement.LoadXml(Resource.Get("Xmpp.Compression.streamfeatures1.xml")).Cast<XmppDotNet.Xmpp.Stream.StreamFeatures>();
            ...
            var feats2 = XmppXElement.LoadXml(Resource.Get("Xmpp.Compression.streamfeatures2.xml")).Cast<XmppDotNet.Xmpp.Stream.StreamFeatures>();
        ...
        public void BuildCompression()
        {
            ...
            var comp = new XmppDotNet.Xmpp.Stream.Features.Compression();
            comp.AddMethod(Methods.Zlib);
            comp.ShouldBe(expectedXml1);

            var comp1 = XmppXElement.LoadXml(Resource.Get("Xmpp.Compression.compression1.xml")).Cast<XmppDotNet.Xmpp.Stream.Features.Compression>();
            comp1.Supports(Methods.Zlib).ShouldBe(true);
            comp1.Supports(Methods.Lzw).ShouldBe(false);

            var comp2 = XmppXElement.LoadXml(Resource.Get("Xmpp.Compression.compression2.xml")).Cast<XmppDotNet.Xmpp.Stream.Features.Compression>();
        ...
        {
            var comp = XmppXElement.LoadXml(Resource.Get("Xmpp.Compression.compression3.xml")).Cast< XmppDotNet.Xmpp.Compression.Compression>();
