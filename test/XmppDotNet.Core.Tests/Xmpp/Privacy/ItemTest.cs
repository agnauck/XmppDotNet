...
using XmppDotNet.Xmpp.Privacy;
using Shouldly;
using Xunit;
using Item = XmppDotNet.Xmpp.Privacy.Item;
...
namespace XmppDotNet.Tests.Xmpp.Privacy
{
    ...
    public class ItemTest
    {
        ...
        public void TestItem()
        {
            ...
            Assert.Equal(XmppDotNet.Xmpp.Privacy.Action.Deny, item.Action);
            Assert.Equal(5, item.Order);
            Assert.Equal(XmppDotNet.Xmpp.Privacy.Type.Subscription, item.Type);
        }
