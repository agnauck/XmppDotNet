...
using XmppDotNet.Xmpp.Search;
using Shouldly;
using Xunit;

namespace XmppDotNet.Tests.Xmpp.Search
{
    public class SearchTest
    {
        ...
        public void XmlShouldBeOfTypeSearch()
        {
            ...
            XmppXElement.LoadXml(xml).ShouldBeOfType<XmppDotNet.Xmpp.Search.Search>();
        }
        ...
        {
            string xml = Resource.Get("Xmpp.Search.search_query1.xml");
            var search = XmppXElement.LoadXml(xml).Cast<XmppDotNet.Xmpp.Search.Search>();
        ...
        public void TestAllItemsWithproperties()
        {
            ...
            var searchQuery = iq.Query.Cast<XmppDotNet.Xmpp.Search.Search>();
        ...
        public void TestBuildSearchQuery()
        {
            ...
            var searchQuery = new IqQuery<XmppDotNet.Xmpp.Search.Search>()
            {
