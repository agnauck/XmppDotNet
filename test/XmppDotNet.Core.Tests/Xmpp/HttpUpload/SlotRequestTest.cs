...
namespace XmppDotNet.Tests.Xmpp.HttpUpload
{
    public class SlotRequestTest
    {
        ...
        public void TestBuildRequestIq()
        {
            ...
            var iq = new Iq { Type = XmppDotNet.Xmpp.IqType.Result, Id = "step_03", To = "romeo@montague.tld/garden", From = "upload.montague.tld" };
            iq.Add(slot);
