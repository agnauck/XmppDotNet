...
using XmppDotNet.Xmpp.StreamManagement;
using XmppDotNet.Xmpp.StreamManagement.Ack;
using Shouldly;
using Xunit;

namespace XmppDotNet.Tests.Xmpp.StreamManagement
{
    public class StreamManagementTest
    {
        ...
        {
            new XmppDotNet.Xmpp.Stream.Features.StreamManagement { Optional = true }.ShouldBe(Resource.Get("Xmpp.StreamManagement.sm1.xml"));
        }
        ...
        public void TestFailed()
        {
            ...
            Assert.True(failed.Condition == XmppDotNet.Xmpp.Base.ErrorCondition.UnexpectedRequest);
        }
        ...
        public void FailedStanzaShouldIncludeItemNotFound()
        {
            ...
            Assert.True(failed.Condition == XmppDotNet.Xmpp.Base.ErrorCondition.ItemNotFound);
        }
