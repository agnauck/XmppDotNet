namespace XmppDotNet.Extensions.Tests.Client
{
    ...
    public class PubSubExtensionsTests
    {
        ...
        public void ModifyAffiliations()
        {
            ...
            var affs = new XmppDotNet.Xmpp.PubSub.Owner.Affiliation[3];
            affs[0] = new XmppDotNet.Xmpp.PubSub.Owner.Affiliation { Jid = "hamlet@denmark.lit", AffiliationType = AffiliationType.None };
            affs[1] = new XmppDotNet.Xmpp.PubSub.Owner.Affiliation { Jid = "polonius@denmark.lit", AffiliationType = AffiliationType.None };
            affs[2] = new XmppDotNet.Xmpp.PubSub.Owner.Affiliation { Jid = "bard@shakespeare.lit", AffiliationType = AffiliationType.Publisher };
